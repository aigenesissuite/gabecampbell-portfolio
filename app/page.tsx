...
import { BrandHeader, Section, Stat } from "@/components/site";
  ...
  return (
    <main>
      <header className="hero">
        <div className="wrap">
          <HeroStream />
          <span className="eyebrow">Principal AI Design Engineer</span>
          <h1>
          ...
          <p className="sub">
            13+ years at Google, BMW, and enterprise fintech — then I designed
            and engineered aiOS end to end, solo: the design system, the
            codebase, the agent architecture. One hand, zero handoffs.
          </p>
          <Walkthrough
            title="Watch what shipped"
            subtitle="The full walkthrough in four chapters — skip around like stories. Everything shown is live in production, narrated by me."
          />
        </div>
      </header>
      ...
      <Section id="highlights">
        <div className="stat-row stagger-children">
          <Stat num="Live" label="aiOS in production, built end to end solo" />
